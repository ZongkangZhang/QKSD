...
## Description
  ...
  * In the folder [practical_implementation](https://github.com/ZongkangZhang/QKSD/tree/main/practical_implementation): [regularisation.nb](https://github.com/ZongkangZhang/QKSD/blob/main/practical_implementation/regularisation.nb) shows that the measurement costs computed by the theorem are close to the necessary measurement costs when using the regularisation method. [thresholding.nb](https://github.com/ZongkangZhang/QKSD/blob/main/practical_implementation/thresholding.nb) compares the necessary measurement costs between different quantum KSD algorithms when using thresholding procedure. The above scripts import the package [QLanczos_package.m](https://github.com/ZongkangZhang/QKSD/blob/main/practical_implementation/QLanczos_package.m) and take the instance (Heisenberg, chain, d=5) as an example.
